                                ...
                                <div class="card-body p-4 p-lg-5 text-black">
                                    ...
                                    <form method="post" action="../exercice4/index.php">
                                        ...
                                        <div class="d-flex align-items-center mb-3 pb-1">
                                            ...
                                            <span class="h1 fw-bold mb-0">COOKIE</span>
                                        </div>

                                        <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">EXERCICE 3</h5>
                                        <!-- INPUT LOGIN -->
                                        ...
                                        <!-- INPUT PASSWORD -->
                                        <div class="form-outline mb-4">
                                            <input type="password" id="form2Example27" name="password" class="form-control form-control-lg" value="<?= $_COOKIE['password'] ?? '' ?>" />
