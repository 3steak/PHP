...
$userAddressIp = $_SERVER['SERVER_ADDR'];
...
<body>
    <nav class="nav">
        <div class="container">
            <div class="logo">
                <a href="/partie8/index.php">PARTIE 8</a>
            </div>
    ...
    <div style="height: 1000px">
        ...
        <div class="container-fluid p-4 text-center text-white">
            <div class="row">
                <div class="">
                    <h3>BONJOUR VOICI VOS DONNEES:</h3>
                    <p> Votre User Agent : <?= $userAgent ?></p>
                    <p>Votre Adresse IP : <?= $userAddressIp ?></p>
                    <p>Votre Nom de Serveur : <?= $userServerName ?></p>
                </div>
            </div>
        </div>
    </div>
