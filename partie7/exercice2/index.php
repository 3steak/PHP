    ...
    <div class="card p-4 m-4 bg-dark text-white">
        ...
        <form method="post" action="../user.php">
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="lastname2" id="lastname" aria-describedby="lastnameHelp">
                <div id="lastnameHelp" class="form-text text-white">Enter your lastname</div>
            </div>
            <div class="mb-3">
                <label for="firstname" class="form-label">Firstname</label>
                <input type="text" class="form-control" name="firstname2" id="firstname" aria-describedby="firstnameHelp">
