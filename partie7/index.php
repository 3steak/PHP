        ...
        <div class="row">
            <div class="col-8 mx-auto">
                <div class="card bg-dark text-white p-4">
                    ...
                    <?php
                    } elseif (!empty($_POST['civility']) && !empty($_POST['lastname']) && !empty($_POST['firstname']) && $_FILES['file']['type'] == 'application/pdf') {
                    ...
                    ?>
                        <div class="alert alert-danger" role="alert">
                            Veuillez remplir tous les champs du formulaire, votre fichier doit être au format PDF !
                        </div>
                    <?php } ?>
