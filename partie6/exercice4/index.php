...
<body class=".bg-light-subtle">
    ...
    <div class="card p-4 m-4 bg-dark text-center text-white">
        <div class="text-center m-2">
            <a class="btn btn-light w-25 mx-auto" href="index.php?language=PHP&server=LAMP" role="button">CLIQUE !</a>
        </div>
        ...
        <div class="exercice text-center m-2">
            ...
            if (isset($_GET['language']) && isset($_GET['server'])) {
                ...
                $server = $_GET['server'];
                echo "Nous étudions le language  $language<br><hr>";
                echo "Nous utilisons comme serveur $server pour les exercices";
            } else {
