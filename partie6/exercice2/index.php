...
<body class=".bg-light-subtle">
    ...
    <div class="card p-4 m-4 bg-dark text-center text-white">
        <div class="text-center m-2"> <a class="btn btn-light w-25 mx-auto" href="index.php?lastname=Nemare&firstname=Jean" role="button">CLIQUE !</a>
        </div>
        <div class="exercice text-center m-2">
            ...
            if (isset($_GET['lastname']) && isset($_GET['firstname']) && isset($_GET['age'])) {
                ...
                echo "La premiere variable lastname a pour valeur  $lastname<br><hr>";
                echo "La deuxieme variable firstname a pour valeur $firstname";
            } else {
                echo 'L\'un des paramètres est manquant';
            }
            ?>
        </div>
    </div>
